...
import com.truck.utils.gateway.utils.define.Evaluater;
...
public class EvaluaterProvider implements Opcodes {
    ...
    private static <TLeft, TRight> Evaluater<TLeft, TRight> createEvaluater(Class<TLeft> leftClass, Class<TRight> rightClass) {
        ...
        String className = "com.truck.utils.gateway.utils.autogen.Evaluator_" + l_name.substring(l_name.lastIndexOf('/') + 1).replace("/", "") + "_" + r_name.substring(
        ...
        try {
            cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, c_name, "Ljava/lang/Object;Lcom/truck/common/gateway/utils/define/Evaluater<" + l_desc + r_desc + ">;",
