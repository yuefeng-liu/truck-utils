...
public class POJOSerializerProvider implements Opcodes {
    ...
    private static <T> Serializer<T> build(Class<T> clazz) {
        ...
        String className = "com.truck.utils.gateway.utils.autogen.Serializer_" + clazz.getName().replace('.', '_');
        ...
        try {
            ...
            cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, c_name, "Ljava/lang/Object;Lcom/truck/utils/gateway/utils/define/Serializer<" + t_classDesc + ">;", "java/lang/Object",
            ...
            }
            {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    pmv.visitFieldInsn(GETSTATIC, "com/truck/utils/gateway/utils/define/ConstField", "UTF8", "Ljava/nio/charset/Charset;");
    ...
    private static void buildToXml(String cn, PoCMethodVisitor pmv, Class<?> clazz, List<Field> fds, String classDesc, String t_className,
        ...
        for (Field fd : fds) {
            ...
            if (t == boolean.class || t == byte.class || t == short.class || t == char.class || t == int.class || t == long.class || t == float.class || t == double.class) {
                ...
                if (isCollection) {
                    ...
                    pmv.visitMethodInsn(INVOKESTATIC, "com/truck/utils/gateway/utils/util/POJOSerializerProvider", "writeXmlString",
                ...
                if (isCollection) {
                    ...
                    pmv.visitMethodInsn(INVOKESTATIC, "com/truck/utils/gateway/utils/util/POJOSerializerProvider", "getSerializer",
                            "(Ljava/lang/Class;)Lcom/truck/utils/gateway/utils/define/Serializer;");
                    ...
                    pmv.loadArg(2); // load out
                    pmv.loadConst(0);
                    pmv.visitMethodInsn(INVOKEINTERFACE, "com/truck/utils/gateway/utils/define/Serializer", "toXml", "(Ljava/lang/Object;Ljava/io/OutputStream;Z)V");
                    writeXmlEnd(cn, pmv, name.endsWith("List") ? name.substring(0, name.length() - 4) : "item", 2, map, list);
                    pmv.visitJumpInsn(GOTO, label_loop);
                    pmv.visitLabel(label_finish);
                    writeXmlEnd(cn, pmv, name, 2, map, list);
        ...
        pmv.visitInsn(DUP);
        pmv.visitFieldInsn(GETSTATIC, "com/truck/utils/gateway/utils/entity/ApiReturnCode", "UNKNOWN_ERROR", "Lcom/truck/utils/gateway/utils/entity/AbstractReturnCode;");
        pmv.loadLocal("e");
        pmv.visitMethodInsn(INVOKESPECIAL, "com/truck/utils/gateway/utils/entity/ReturnCodeException", "<init>",
                "(Lcom/truck/utils/gateway/utils/entity/AbstractReturnCode;Ljava/lang/Exception;)V");
    ...
    private static void buildToJsonWithFastJson(String cn, PoCMethodVisitor pmv, Class<?> clazz, List<Field> fds, String classDesc,
        ...
        pmv.loadArg(2);
        pmv.loadArg(1);
        pmv.visitFieldInsn(GETSTATIC, "com/truck/utils/gateway/utils/define/Serializer$ApiSerializerFeature", "SERIALIZER_FEATURES", "[Lcom/alibaba/fastjson/serializer/SerializerFeature;");
