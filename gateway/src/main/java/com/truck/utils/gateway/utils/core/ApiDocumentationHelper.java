...
import com.truck.utils.gateway.utils.annotation.EnumDef;
import com.truck.utils.gateway.utils.define.CommonParameter;
import com.truck.utils.gateway.utils.document.*;
...
import com.truck.utils.gateway.utils.entity.ReturnCodeContainer;
...
public class ApiDocumentationHelper {
    ...
    private RespStruct buildVirtualListStruct(String groupName, Class<?> clazz) {
        ...
        if (!clazz.getName().startsWith("com.truck.utils.gateway.utils.")) {
    ...
    private String getEntityName(String group, Class<?> type) {
        return (group == null || group.length() == 0 || type.getName().startsWith(
                "com.truck.utils.gateway.utils.")) ? "Api_" + type.getSimpleName() : "Api_" + group.toUpperCase() + "_" + type.getSimpleName();
    }

    private String getEntityName4CollectionAndArray(String group, Class<?> type) {
        return (group == null || group.length() == 0 || type.getName().startsWith(
                "com.truck.utils.gateway.utils.")) ? "Api_" + type.getSimpleName() + "_ArrayResp" : "Api_" + group.toUpperCase() + "_" + type.getSimpleName() + "_ArrayResp";
    }
